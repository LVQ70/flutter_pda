...
class InsertFeedingTwo extends StatelessWidget {
  final arguments;
  InsertFeedingTwo({this.arguments});
...
class _TextFieldDemoState extends State<TextFieldDemo> {
  ...
  Future<dynamic> getCheck(String eqpString) async {
    var url = httpURL + "/custom/Pda/sl_tlk_check";
  ...
  Future<dynamic> getVoted(String itemCode) async {
    var url = httpURL + "/custom/Pda/votedMateriel_slj";
    var response = await http.post(url,
        body: json.encode({
