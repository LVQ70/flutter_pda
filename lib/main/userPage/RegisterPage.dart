...
class _RegisterPageState extends State<RegisterPage> {
  ...
  int yzmType = 1; //1-注册 2-重置密码 3-验证码登录
  int i = 60; //验证码计时器
  bool obscure = true;
  String yzmText = '获取';
  ...
  int index = 1;
  List listRegister = [
    "assets/login/btn-zhuce.png",
    "assets/login/btn-zhuce2.png"
  ];
...
//注册
  getData() async {
    var url =
        "http://courage.cqscrb.top/system/register?phone=${this.phone}&password=${this.password}&confirmPassword=${this.upassword}&code=${this.code}&type=${this.type}&project=${this.project}";
    var response = await http.post(url);
